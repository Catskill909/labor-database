      ...
      <header className="border-b border-white/5 px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex items-center gap-2 w-full sm:flex-1 sm:max-w-xl">
            ...
            {/* Hamburger — mobile only, next to search */}
          ...
          {/* Desktop only: Add button + hamburger */}
          <div className="hidden sm:flex items-center gap-4 ml-auto">
            <button
              onClick={onAddClick}
              className="flex items-center gap-2 px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors shrink-0"
            >
              <Plus size={16} />
              Add to Database
            </button>
